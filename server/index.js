...
app.all('/api-openai/*', createProxyHandler((path) => `https://api.openai.com${path}`));
app.all('/api-openrouter/*', createProxyHandler((path) => `https://openrouter.ai${path}`));
app.all('/api-gemini/*', createProxyHandler((path) => `https://generativelanguage.googleapis.com${path}`));
